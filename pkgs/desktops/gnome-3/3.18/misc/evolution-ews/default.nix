{ stdenv, fetchgit, gnome3, glib, intltool, pkgconfig, gtk_doc, libtool, gtk, libsoup, sqlite, webkitgtk } :
...
stdenv.mkDerivation {
  ...
  buildInputs = [ gnome3.gnome_common gnome3.evolution_data_server gnome3.evolution
                  glib intltool pkgconfig gtk_doc libtool gtk libsoup sqlite webkitgtk ];
