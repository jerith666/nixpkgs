...
- Two new packages `gpauth` and `gpclient`
...
- Two new packages `gpauth` and `gpclient` from the 2.x version of the
  GlobalProtect-openconnect project are added. The GUI components
  related to the project are non-free and not packaged.
